...
( set -x ; git clone git@github.com:htc-ccis1505/$1.git master)

echo ""
echo "Creating orphan branch, empty gh-pages/ directory."
( set -x ; git clone git@github.com:htc-ccis1505/$1.git gh-pages)
...
(set x; cd ./master; git remote add core https://github.com/htc-ccis1505/morea-core-custom.git)
